...
use Provectus\SlackApi\Contracts\SlackApi;
...
abstract class SlackMethod
{
    ...
    /**
     * @var \Provectus\SlackApi\Contracts\SlackApi
     */
    protected $api;
    ...
    /**
     * @param \Provectus\SlackApi\Contracts\SlackApi  $api
     * @param Cache $cache
     */
    ...
    /**
     * Returns the api.
     * @return \Provectus\SlackApi\Contracts\SlackApi
     */
